...
var _formField = _interopRequireDefault(require("./form/form-field"));
  ...
  (0, _createClass2["default"])(MTableEditRow, [{
    ...
    value: function renderColumns() {
      ...
      var mapArr = this.props.columns.filter(function (columnDef) {
        ...
        var value = _this2.state.data[columnDef.field];
        var style = {};
        ...
        if (!columnDef.field || _this2.props.mode !== 'add' && columnDef.readonly) {
          ...
          }, React.createElement(_formField["default"], {
            key: columnDef.tableData.id,
            columnDef: columnDef,
            value: value,
